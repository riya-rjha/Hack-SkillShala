...
import "./Roadmap.css";
import DescriptionImage from "../assets/description-img-1.jpg"; // your existing CSS for the roadmap
  ...
  return (
    <div className="roadmap-container">
      ...
      <div className="description">
        <h1>
          <u>Demotivated & Unemployed?</u>
        </h1>
        <Box className="description-image-container">
          <img
            src={DescriptionImage} alt="Description Image"
          />
        </Box>
        <Box>
          <Typography variant="body1" className="description-text">
            Feeling stuck or unsure of your next step? We’ve got exactly what
            you need, tailored to your situation — No fees, no payments,
            absolutely <span>FREE!</span> Take a Skill based test today & know
            where you stand. And if required,
            <span> We & Ai are there to assist you!!</span>
          </Typography>
          <Button
            variant="contained"
            sx={{
              backgroundColor: "#18E4C7",
              color: "black",
              fontWeight: "800",
            }}
          >
